        ...
        $.post(
            {
                ...
                success: function (informacion)
                {
                    ...
                    // verifica si hay correos pendientes, y si los hay los envía (función del header).
	...
	<div class="footer-copyright">
		...
		<div class="container">
            ...
            <span>©
              ...
              </script> <a class="grey-text text-lighten-4" href="https://www.cointic.com.mx" target="_blank">Sistema de gestión DLP.</a> Todos los derechos reservados.</span>
...
<script type="text/javascript" src="<?=base_url('assets/')?>js/jquery.tabledit.min.js"></script>
...
<script type="text/javascript" src="<?=base_url('assets/')?>fonts/fontawesome/js/all.js"></script>

<audio id="audiotag1" src="<?=base_url('assets/notification/piano_chord.wav')?>" preload="auto"></audio>
