	        ...
	        <section id="content">
	            ...
	            <div class="container">
	                ...
	                <div id="editableTable" class="section">
	                    <div class="row">
	                        <div class="col s11">
	                            <h4 class="header">Mis Facturas</h4>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col s12" align="center">
	                            <div class="card" style="width: 18rem;">
	                                <div class="card-body">
	                                    <h5 class="card-title">Vaya.. no hay facturas por aquí </h5>
	                                    <h6 class="card-subtitle mb-2 text-muted"></h6>
	                                    <p class="card-text">Parece que aun no tiene facturas asignadas a esta razón social.</p>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
	    ...
	    function deleteFactura(idPq) {
	        Swal.fire({
	            ...
	            if (result.value) {
	                ...
	                $.ajax({
	                    url: "http://localhost/panel/index.php/CrudFacturas/eliminarFactura/" + idPq,
	                    type: "post",
	                    dataType: "HTML",
	                    success: function(data) {
	                        loadUrl('CrudFacturas')
	                    },
