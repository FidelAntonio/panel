<div class="container">
    <div class="row">
        <div class="col s12">
            <div class="col s4">
                <h4 class="header">Editar paquete</h4>
            </div>
        </div>
                ...
                <div class="card-panel">
                    <div class="row">
                        <form id="formulario">
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    <textarea rows="4" id="descripcion" name="descripcion" class="materialize-textarea" placeholder="Descripción"></textarea><label for="textarea1">Descripción</label>
                                </div>
                                <div class="input-field col s6">
                                    <textarea rows="4" id="caracteristicas" name="caracteristicas" class="materialize-textarea" placeholder="Características"></textarea><label for="textarea1">Características</label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="input-field col s4">
                                    <input type="hidden" name="paqueteId" id="paqueteId" value="<?php echo $idPaquete; ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?= base_url('/index.php/Crudpaquetes/editaPaquete/' . $idPaquete) ?>',
                dataType: 'JSON',
                type: 'POST',
        ...
        $("#formulario").submit(function(e) {
            ...
            $.ajax({
                url: '<?= base_url('index.php/Crudpaquetes/actualizarPaquete') ?>',
                data: formData,
                contentType: false,
                processData: false,
                type: 'POST',
                ...
                success: function(data) {
                    Swal.fire({
                        title: 'Éxito',
                        html: 'Se actualizaron los datos del paquete',
                        icon: 'success'
                    });
