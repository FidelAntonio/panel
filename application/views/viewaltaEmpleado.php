...
<div class="container">
    ...
    <script>
        ...
        //     $( "#nombreEmpleado"+i ).rules( "add", {
        //         required: true,
        //         minlength: 3,
        //         lettersonly: true,
        //     });
        //     $( "#apPaterno"+i ).rules( "add", {
        //         required: true,
        //         minlength: 3,
        //         lettersonly: true
        //     });
        //     $( "#apMaterno"+i ).rules( "add", {
        //         required: true,
        //         minlength: 3,
        //         lettersonly: true
        //     });
        //     $( "#fechaNac"+i ).rules( "add", {
        //         required: true,
        //     });
        //     $( "#idPa"+i ).rules( "add", {
        //         required: true,
        ...
        //         alphanumeric: true
        //     });
        //     $( "#direccion"+i ).rules( "add", {
        //         required: true,
        //         minlength: 4
        //     });
        //     $( "#telefono"+i ).rules( "add", {
        //         required: true,
        //         minlength: 10
        //     });
        //     $( "#rfc"+i ).rules( "add", {
        ...
        function pintarFormulario() {
            ...
            for (i = 0; i < numEmpleados; i++) {
                $('#empleados').append('<div class="container" id="Empleado' + i + '">' +
                    ...
                    '<div class="input-field col s4">' +
                    '<input oninput="mostrarPaso3()" id="salarioB' + i + '" name="salarioB' + i + '" type="text" placeholder="Salario base" class="salarioB" required readonly>' +
                    
                    '</div>' +

                    '<div class="form-check col s4">' +
                    '<div class="col offset">' +
                    '<br><input  type="checkbox" class="" name="check' + i + '" id="check' + i + '" onchange="showContent(),mostrarPaso3()">' +
                    '<label class="" for="check' + i + '">¿Cuenta con número social?</label><br>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '<div class="row">' +
        ...
        function cargaDatospago() {
            document.getElementById("ntarjeta").scrollIntoView();;
            // window.scrollTo(0,document.querySelector("#pago").scrollHeight);
        ...
        $("#formulario").submit(function(e) {
            ...
            if (validar()) {
                ...
                formDataToken.append('idUsuario', <?= $this->session->userdata('iduser') ?>)
                $.ajax({
